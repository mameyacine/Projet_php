...
<body>
    ...
    <div class="container mx-auto">
        ...
        <table class="table min-w-full bg-white">
            ...
            $stmt_interventions = $pdo->prepare("SELECT i.*, c.nom_utilisateur AS client_nom, inv.nom_utilisateur AS intervenant_nom, s.nom_utilisateur AS standardiste_nom FROM Intervention i LEFT JOIN Client c ON i.ID_client = c.ID_client LEFT JOIN Intervenant inv ON i.ID_intervenant = inv.ID_intervenant LEFT JOIN Standardiste s ON i.ID_standardiste = s.ID_standardiste ORDER BY $sortBy $order");
