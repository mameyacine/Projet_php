...
<nav class="  p-4 mb-8">
    <div class="mx-auto flex justify-between items-center">
        ...
        <div class="flex">
            <a href="voir_tout.php?idST=<?php echo htmlspecialchars($id_standardiste); ?>" class="button" ><i class="fas fa-arrow-rotate-left"></i></a>
...
<body>
        ...
        <h1 class="text-3xl text-center font-bold m-4">Historique de Toutes Les Interventions</h1>
        ...
        <table class="table min-w-full bg-white">
            ...
            <tr>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?sort=description&order=" . $nextOrder . "&idST=" . htmlspecialchars($id_standardiste); ?>">Description</a>
                </th>
        
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?sort=degre_urgence&order=" . $nextOrder . "&idST=" . htmlspecialchars($id_standardiste); ?>">Degré d'urgence</a>
                </th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?sort=client_nom&order=" . $nextOrder . "&idST=" . htmlspecialchars($id_standardiste); ?>">Client</a>
                </th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?sort=intervenant_nom&order=" . $nextOrder . "&idST=" . htmlspecialchars($id_standardiste); ?>">Intervenant</a>
                </th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?sort=standardiste_nom&order=" . $nextOrder . "&idST=" . htmlspecialchars($id_standardiste); ?>">Standardiste</a>
                </th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?sort=date_heure&order=" . $nextOrder . "&idST=" . htmlspecialchars($id_standardiste); ?>">Date</a>
                </th>
                <th class="text-left py-3 px-4 uppercase font-semibold text-sm">
                    <a href="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . "?sort=date_heure&order=" . $nextOrder . "&idST=" . htmlspecialchars($id_standardiste); ?>">Heure</a>
                </th>
            </tr>
            </thead>
